            ...
            switch (this.anchor) {
                case (this.TOP):
                    if (this._canMoveStraightClock())
                        this.x += 1;
                    else if (this._canTurnClock())
                        this.anchor = this.RIGHT;
                    else if (this._canClimbClock())
            ...
            switch (this.anchor) {
                case (this.TOP):
                    if (this._canMoveStraightCounter())
                        this.x -= 1;
                    else if (this._canTurnCounter())
                        this.anchor = this.LEFT;
                    else if (this._canClimbCounter())
                        this.anchor = this.RIGHT;
                    else
                        this._reverseDirection();
                    break;
